...
export const BottomLine = () => {
  return (
    <>
      ...
      <Plus className='pointer-events-none absolute left-[2.1875rem] top-[54.9375rem] z-2 hidden xl:block' />

      <Plus className='pointer-events-none absolute right-[2.1875rem] top-[54.9375rem] z-2 hidden xl:block' />
    </>
  )
}
